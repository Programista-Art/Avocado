...
## A unique feature of this language is the ability to write commands in Polish and compile code into .exe format. The language is available free of charge for commercial and non-commercial projects. 258 functions have been implemented!
...
Polish, English, German, French, Spanish, Russian.

## 🥑 Support the Avocado Project

Hey! If you like my **Avocado programming language** project, you can now support its development:  

[![Patronite](https://img.shields.io/badge/💻_Support_on-Patronite-red?style=for-the-badge)](https://patronite.pl/programista-art)
[![Ko-fi](https://img.shields.io/badge/☕_Buy_me_a_coffee-Ko--fi-5cb85c?style=for-the-badge)](https://ko-fi.com/programistaart)
...
![Avocado v 2.2.0.0](image/v2.2.0.0/avocado-polish-programming-language1.png)
### Avocado available languages 
![Avocado application examples v 2.2.0.0](image/v2.2.0.0/avocado-polish-programming-language2.png)

### Writing procedures in Polish
![Avocado application examples v 2.2.0.0](image/v2.2.0.0/avocado-polish-programming-language3.png)

### Writing procedures in English
![Avocado application examples v 2.2.0.0](image/v2.2.0.0/avocado-polish-programming-language4.png)

### Writing functions in Polish
![Avocado application examples v 2.2.0.0](image/v2.2.0.0/avocado-polish-programming-language5.png)

### Compiler Settings in Avocado
![Avocado application examples v 2.2.0.0](image/v2.2.0.0/avocado-polish-programming-language6.png)


### Sample applications in Avocado
![Avocado application examples v 2.2.0.0](image/v2.2.0.0/avocado-polish-programming-language7.png)

### Temporary project files
![Avocado application examples v 2.2.0.0](image/v2.2.0.0/avocado-polish-programming-language8.png)
...
## Unikalną cechą tego języka jest możliwość pisania komend w języku polskim oraz angielskim, kompilacja kodu do formatu .exe. Język jest dostępny bezpłatnie dla projektów komercyjnych i niekomercyjnych. Zrealizowano 258 funkcji!
...
+ Polskie słowa kluczowe oraz angielskie – ułatwiają naukę i pracę.
...
+ Interfejs Avocado IDE został przetłumaczony na 6 języków
...
[![Patronite](https://img.shields.io/badge/💻_Wesprzyj_na-Patronite-red?style=for-the-badge)](https://patronite.pl/programista-art)
[![Ko-fi](https://img.shields.io/badge/☕_Buy_me_a_coffee-Ko--fi-5cb85c?style=for-the-badge)](https://ko-fi.com/programistaart)
...
![Avocado v 2.2.0.0](image/v2.2.0.0/avocado-polish-programming-language1.png)
### Avocado dostępne języki 
![Avocado application examples v 2.2.0.0](image/v2.2.0.0/avocado-polish-programming-language2.png)

### Własne procedury po polsku
![Avocado application examples v 2.2.0.0](image/v2.2.0.0/avocado-polish-programming-language3.png)

### Własne procedury po angielsku
![Avocado application examples v 2.2.0.0](image/v2.2.0.0/avocado-polish-programming-language4.png)

### Własne funkcje po polsku i angielsku
![Avocado application examples v 2.2.0.0](image/v2.2.0.0/avocado-polish-programming-language5.png)

### Ustaiwienie ścieżek do kompilatora i interpretatora FPC
![Avocado application examples v 2.2.0.0](image/v2.2.0.0/avocado-polish-programming-language6.png)


### Przykładowe aplikacje w Avocado 48 sztuk
![Avocado application examples v 2.2.0.0](image/v2.2.0.0/avocado-polish-programming-language7.png)

### Tymczasowe pliki projektu
![Avocado application examples v 2.2.0.0](image/v2.2.0.0/avocado-polish-programming-language8.png)
